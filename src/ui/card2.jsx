...
const NeonCard = ({ className = '' }) => {
    return (
        <div className={`flex items-center justify-center p-8 ${className}`}>

            <div
                className="relative w-full max-w-sm md:max-w-md p-6 sm:p-8 rounded-2xl overflow-hidden shadow-2xl transition-all duration-500 ease-in-out hover:scale-[1.02] 
                   transform animate-pulse-subtle"
                style={{
                    background: '#252528ff',
            ...
            >
                ...
                <div
                    ...
                    style={{
                        ...
                        background: 'radial-gradient(circle at 60% 110%, rgba(44, 44, 45, 0.5) 0%, rgba(0, 0, 0, 0) 70%)',
                        transform: 'scale(1.5)',
                        filter: 'blur(60px)',
                    }}
                ></div>
                ...
                <div className="relative z-10 text-white">
                    ...
                    <div className="mb-8">
                        <p className="text-sm text-blue-400 opacity-70 mb-1 font-mono">/02</p>
                        <h1 className="text-3xl font-bold mb-1 tracking-tight">
                            Neon Frame Studio
                        </h1>
                        <p className="text-sm text-gray-400 tracking-wider">
                            UI/UX Design & Creative Systems
                        </p>
                    </div>

                    <p className="text-xl text-gray-200 leading-relaxed mb-10">
                        We craft stunning interfaces built on **clarity**, **performance**, and **emotion**. Tailored visuals that connect brands with bold identities.
                    </p>
