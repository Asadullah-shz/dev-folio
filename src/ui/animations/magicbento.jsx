      ...
      <style>
        {`
          .bento-section {
            ...
            --border-color: #2c2b2cff;
            --background-dark: #060010;
            --white: hsl(0, 0%, 100%);
            --purple-primary: rgba(65, 64, 66, 1);
            --purple-glow: rgba(68, 67, 69, 0.2);
            --purple-border: rgba(36, 36, 36, 0.8);
          }
          ...
          .card--border-glow:hover {
            box-shadow: 0 2px 10px rgba(41, 41, 42, 0.4), 0 0 10px rgba(${glowColor}, 0.2);
          }
          ...
          .particle-container:hover {
            box-shadow: 0 4px 20px rgba(41, 41, 42, 0.2), 0 0 30px rgba(${glowColor}, 0.2);
          }
